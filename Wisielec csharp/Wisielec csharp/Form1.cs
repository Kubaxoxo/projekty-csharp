                ...
                for (int i = 1; i < 6; i++)
                {
                    if (Convert.ToString(slowo[i]) == litera)
                    {
                        ...
                        if (czy_trafiony == false)
                        {
                            ...
                            if (ile_pudel == 1) { pictureBox1.Image = Wisielec_csharp.Properties.Resources.stan1; }
                            if (ile_pudel == 2) { pictureBox1.Image = Wisielec_csharp.Properties.Resources.stan2; }
                            if (ile_pudel == 3) { pictureBox1.Image = Wisielec_csharp.Properties.Resources.stan3; }
                            if (ile_pudel == 4) { pictureBox1.Image = Wisielec_csharp.Properties.Resources.stan4; }
                            if (ile_pudel == 5)
                            {
                                pictureBox1.Image = Wisielec_csharp.Properties.Resources.stan5;
                    ...
                    {
                        pictureBox1.Image = Wisielec_csharp.Properties.Resources.przegrana;
                    }
                }
            }
        }
                ...
                if (label3.Text != "_")
                {
                    if (label4.Text != "_")
                    {
                        if (label5.Text != "_")
                        {
                            if (label6.Text != "_")
                            {
                                pictureBox1.Image = Wisielec_csharp.Properties.Resources.wygrana;
                                button2.Visible = true;
                            }
                        }
                    }
